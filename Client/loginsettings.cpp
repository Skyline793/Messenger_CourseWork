...
QString LoginSettings::GetServerAddress() const {
...
int LoginSettings::GetServerPort() const {
    return serverPort;
}
...
QString LoginSettings::GetNickname() const {
    return nickname;
}
...
QString LoginSettings::GetPassword() const {
    return password;
}

void LoginSettings::SaveSettings() const {
...
bool LoginSettings::IsConfigured() const {
